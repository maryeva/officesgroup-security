  ...
  <section class="px-6 py-20 md:py-20 bg-white">
    ...
    <div v-if="status !== 'success'" class="min-h-[100px] flex justify-center items-center">
      <div v-if="loadingText">
        <div role="status">
          <svg aria-hidden="true" class="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-[#EF1B27]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
